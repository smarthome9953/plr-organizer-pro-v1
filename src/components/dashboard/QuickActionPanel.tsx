...
import { Upload, FileText, FolderPlus, Download, Search, Edit, Palette, Wrench, RefreshCw, Shield, FileSearch, PercentSquare, Globe, FileType, FileScan, FileCode, Replace } from 'lucide-react';
